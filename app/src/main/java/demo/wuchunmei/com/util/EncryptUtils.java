...
import demo.wuchunmei.com.util.CloseIOUtils;
import demo.wuchunmei.com.util.ConvertUtils;
...
public class EncryptUtils {
    ...
    public static String encryptMD5ToString(byte[] data) {
        return ConvertUtils.bytes2Hex(encryptMD5(data));
    }
    ...
    public static String encryptSHA1ToString(byte[] data) {
        return ConvertUtils.bytes2Hex(encryptSHA1(data));
    }
